...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ url('/') }}"><i class="fa fa-dashboard"></i> Data Siswa</a></li>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <a href="{{ url('siswa') }}" class="btn bg-purple"><i class="fa fa-chevron"></i>Kembali</a>
        </div>
        <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
               <div class="checkbox">
                 ...
                 <label><input type="radio" name="jenis_kelamin" value="L" {{ (@$result -> jenis_kelamin == 'P' ? 'checked' : '') }} /> P</label>
               </div>
              </div>
            </div>
            <div class="form-group">
