    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <a href="{{ url('kelas/add') }}" class="btn btn-succ"><i class="fa-plus-circle"></i>Tambah</a>
        </div>
        <div class="box-body">
          <table class="table table-stripped">
            ...
            <tbody>
              ...
              <tr>
                <td>{{ !empty($i) ? ++$i : $i = 1 }}</td>
				<td>
					<img src= {{ asset ('uploads/'.@row->foto)}} width="80px"> class="img"</img>
                ...
                <form action="{{ url("siswa/$row->nis/delete") }}" method="POST" style="display:inline;">
                  {{ csrf_field() }}
                  {{ method_field('DELETE') }}
                  <button class="btn btn-sm bt-danger"><i class="fa fa-trash"></i></a></button>
                </form>
                </td>
              </tr>
                @endforeach
